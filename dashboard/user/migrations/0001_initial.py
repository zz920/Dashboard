    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.PositiveIntegerField(choices=[(1, 'Admin'), (2, 'Client User'), (3, 'Fetchr User')], default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('access', models.ManyToManyField(related_name='access', to='user.Access')),
            ],
            options={
